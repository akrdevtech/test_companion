...
const StudentWizardCourseInfo = (props: IStudentWizardActiveTabCommonProps) => {
    ...
    const handleGenerateAdmissionNumber = () => {
        studentServices.getAutogeneratedAdmissionNumber(course.value || "", dateOfAdmission.value || new Date()).then(autoAdmno => {
            handleInputChange(EAddStudentWizardCourseInfoFields.STUDENT_ADMISSION_NUMBER, autoAdmno);
        })
    }
